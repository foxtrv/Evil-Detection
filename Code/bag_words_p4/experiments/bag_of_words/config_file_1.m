...
RUN_DIR =  ['~/Desktop/385 Final Project/Code/bag_words_p4/experiments/bag_of_words'];

%%% Directory holding all the source images
IMAGE_DIR = [ '~/Desktop/385 Final Project/Code/bag_words_p4/images'] ;
